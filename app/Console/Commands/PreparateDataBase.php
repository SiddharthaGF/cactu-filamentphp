...
final class PreparateDataBase extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:preparate-data-base';
    ...
    public function handle(): void
    {
        if ($this->confirm('¿Deseas continuar?')) {
            try {
                ...
                $this->newLine(1);
                $this->info('Establezca la contraseña, si no ingresa una se generará una aleatoria');
                ...
                Artisan::call('shield:install --fresh -n');
