...
class BankingInformationPolicy
{
    ...
    {
        return $user->can('view_any_banking::information');
    }
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\BankingInformation  $bankingInformation
     * @return bool
     */
    public function view(User $user, BankingInformation $bankingInformation): bool
    {
        return $user->can('view_banking::information');
    }
    ...
    {
        return $user->can('create_banking::information');
    }
    ...
    {
        return $user->can('update_banking::information');
    }
    ...
    {
        return $user->can('delete_banking::information');
    }
    ...
    {
        return $user->can('delete_any_banking::information');
    }
