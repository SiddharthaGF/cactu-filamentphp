...
class MailboxPolicy
{
    ...
    {
        return $user->can('view_any_mailbox');
    }
    ...
    {
        return $user->can('create_mailbox');
    }
    ...
    {
        return $user->can('update_mailbox');
    }
    ...
    {
        return $user->can('delete_mailbox');
    }
    ...
    {
        return $user->can('delete_any_mailbox');
    }
